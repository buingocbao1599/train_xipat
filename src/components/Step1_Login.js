                    ...
                    <Layout.Section>
                        <LegacyCard sectioned>
                            <div className="log_in-main">
                                ...
                                <Text id='log_in-heading'> Access Permission</Text>
                                <p className="log_in-description">This feature requires to connect with your TikTok Ads Manager to create catalogs from Shopify products. Be assured that our program has tightly forbidden any access to sensitive data, such as revenue or customer data</p>
                                <Button id='login_in-tiktok'>
