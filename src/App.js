        ...
        <div className="banner-popup">
          ...
          >
            <Modal.Section>
              <TextContainer>
                <p>
                  A <b>Pixel + Conversion API</b> combined give you the best of both tracking worlds, so Facebook knows who is <b>best to target for better ROAS.</b>
                </p>
                <div className="banner-popup_picture">
                  <img />
                </div>
              </TextContainer>
            </Modal.Section>
